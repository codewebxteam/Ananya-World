  ...
  useEffect(() => {
    if (staffToEdit && isOpen) {
      setFormData({
        ...
        workLocation: staffToEdit.workLocation || '',
        ...
        <div className="p-6 overflow-y-auto">
          ...
          <form id="edit-staff-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <MapPin size={18} className="absolute left-3 top-3 text-gray-400" />
                <input required type="text" name="workLocation" value={formData.workLocation} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all" placeholder="e.g. Lab 1, Central Office, Field" />
              </div>
            </div>
